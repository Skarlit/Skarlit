...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentNavbarJs = __webpack_require__(200);

	var _componentNavbarJs2 = _interopRequireDefault(_componentNavbarJs);

	var _viewExperimentsJs = __webpack_require__(364);

	var _viewExperimentsJs2 = _interopRequireDefault(_viewExperimentsJs);

	var _viewIndexJs = __webpack_require__(368);

	var _viewIndexJs2 = _interopRequireDefault(_viewIndexJs);

	var _viewDemoJs = __webpack_require__(369);

	var _viewDemoJs2 = _interopRequireDefault(_viewDemoJs);

	var _componentPage_frameJs = __webpack_require__(365);

	var _componentPage_frameJs2 = _interopRequireDefault(_componentPage_frameJs);

	var _mouse = __webpack_require__(370);
	...
	var App = _react2["default"].createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        (0, _mouse2["default"])(_react2["default"].findDOMNode(this.refs.background));
	    },
	    render: function render() {
	        return _react2["default"].createElement(
	            ...
	            _react2["default"].createElement(
	                _componentPage_frameJs2["default"],
	                { style: { marginTop: "80px" }, fadeIn: 600 },
	                this.props.children
	            ),
	            _react2["default"].createElement("canvas", { ref: "background" })
	        );
	    }
	});
	...
	var _titleChange = function _titleChange(title) {
	...
	window.onload = function () {
	    _react2["default"].render(_react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	            ...
	            _react2["default"].createElement(_reactRouter.IndexRoute, { component: _viewIndexJs2["default"], onEnter: _titleChange.bind(this, "Home") }),
	            _react2["default"].createElement(_reactRouter.Route, { path: "experiments", component: _viewExperimentsJs2["default"], onEnter: _titleChange.bind(this, "Experiments") }),
	            _react2["default"].createElement(_reactRouter.Route, { path: "experiments/:name", component: _viewDemoJs2["default"], onEnter: _titleChange.bind(this, "Demo") }),
	            _react2["default"].createElement(_reactRouter.Route, { path: "*", component: NotFound, onEnter: _titleChange.bind(this, "Not Found") })
	        )
	    ), document.body);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mixinsMaterial_mixinJs = __webpack_require__(357);
	...
	var SvgIcon = _materialUi2["default"].SvgIcon;

	var NavBar = _react2["default"].createClass({
	    displayName: "NavBar",

	    mixins: [_mixinsMaterial_mixinJs2["default"], _reactRouter.History],
	    contextTypes: {
	    ...
	    render: function render() {
	        ...
	        return _react2["default"].createElement(
	            ...
	            _react2["default"].createElement(
	                "a",
	                { style: styles.homeBtn, href: "/#/" },
	                _react2["default"].createElement(
	                    SvgIcon,
	                    { style: (0, _merge2["default"])(true, styles.icon, pathname == '/' && styles.iconActivate) },
	            ...
	            _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(Tab, { label: "About", value: "/about" }),
	                _react2["default"].createElement(Tab, { label: "Experiments", value: "/experiments" }),
	                _react2["default"].createElement(Tab, { label: "Other", value: "/other" })
	            )
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactTapEventPlugin = __webpack_require__(358);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function injectTapEventPlugin () {
	  ...
	  __webpack_require__(70).injection.injectEventPluginsByName({
	    "ResponderEventPlugin": __webpack_require__(359),
	    "TapEventPlugin":       __webpack_require__(360)
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TouchEventUtils = __webpack_require__(361);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dataJs = __webpack_require__(367);
	...
	var CardMedia = _materialUi2["default"].CardMedia;
	var CardTitle = _materialUi2["default"].CardTitle;
	var CardText = _materialUi2["default"].CardText;

	var Experiments = _react2["default"].createClass({
	    ...
	    itemsList: function itemsList() {
	        var listItems = [];
	        for (var i = 0; i < _dataJs.ExperimentsData.length; i++) {
	            listItems.push(_react2["default"].createElement(ListItem, {
	                primaryText: _dataJs.ExperimentsData[i].title,
	                leftAvatar: _react2["default"].createElement(
	                    Avatar,
	                    { style: styles.avatar },
	                    _dataJs.ExperimentsData[i].type[0].toUpperCase()
	                ),
	                onClick: this.navigate.bind(this, _dataJs.ExperimentsData[i].pathname)
	            }));
	        }
	        return listItems;
	    },
	    render: function render() {
	        return _react2["default"].createElement(
	            ...
	            _react2["default"].createElement(
	                Card,
	                { style: styles.card, initiallyExpanded: true },
	                _react2["default"].createElement(CardMedia, {
	                    style: {
	                    ...
	                    overlay: _react2["default"].createElement(CardTitle, { title: "Experiments", subtitle: "Random pic taken from fastcompany.com." }) }),
	                _react2["default"].createElement(
	                    CardText,
	                    { expandable: true },
	                    _react2["default"].createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddons = __webpack_require__(205);
	...
	var PageFrame = _reactAddons2["default"].createClass({
	    displayName: "PageFrame",

	    componentDidMount: function componentDidMount() {
	        console.log('wasdf');
	        (0, _jquery2["default"])(_reactAddons2["default"].findDOMNode(this)).fadeIn(this.props.fadeIn);
	    },
	    componentWillUnmount: function componentWillUnmount() {},
	    render: function render() {
	        return _reactAddons2["default"].createElement(
	            TransitionGroup,
	            { component: "div", style: this.props.style, transitionAppear: true },
	            this.props.children
	        );
	    }
	});
...
/***/ function(module, exports) {
	...
	var ExperimentsData = [{ type: 'algorithm', title: "Printing a tree", pathname: "tree_print" }];

	exports.ExperimentsData = ExperimentsData;
	var ExperimentsStyle = {
	    "tree_print": {
	        src: "/experiments/tree_print.html",
	        wrapperCss: { height: "500px", width: "100%" },
	        title: "Tree Print",
	        description: "To properly print a tree, we must adjust the position of each node as the tree growth to avoid collisions. " + "This divides the space by number of children. (TODO: use the right/left most children of a subtree to measure the width instead " + "of using just the children."
	    }
	};
	exports.ExperimentsStyle = ExperimentsStyle;
	            ...
	            _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        "h3",
	                        null,
	                        "Rewriting everything in Material-UI...."
	                    )
	                )
	            )
	        );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Demo = _react2["default"].createClass({
	    ...
	    render: function render() {
	        var config = _dataJs.ExperimentsStyle[this.props.params.name] || {};
	        var maxHeight = window.innerHeight - 130;
	        return _react2["default"].createElement(
	            "div",
	            { style: styles.base },
	            _react2["default"].createElement(CardTitle, { style: styles.cardTitle,
	                titleStyle: styles.titleText,
	                subtitleStyle: styles.subTitleText,
	                title: config.title,
	                subtitle: config.description }),
	            _react2["default"].createElement("iframe", { src: config.src,
	                style: (0, _merge2["default"])(true, styles.iframe, config.wrapperCss, { maxHeight: maxHeight }),
	                seamless: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InitMouse = function InitMouse(canvas) {
	    // Canvas setup
	    ...
	    var camera = new _three2['default'].OrthographicCamera(w / -2, w / 2, h / 2, h / -2, 1, 1000);
	    var renderer = new _three2['default'].WebGLRenderer({ canvas: mouseScreen, alpha: true });
	    scene.add(camera);
	    ...
	    var t = 0;
	    var time = 0;
	    var mousePos = new _three2['default'].Vector3();
	    var mouseVelocity = new _three2['default'].Vector3();
	    var deltaT = 0.1;
	    var acceleration = new _three2['default'].Vector3(0, -0.4, 0);

	    var bottomLimit = (function () {
	        return new _three2['default'].Vector3(0, -1, 0.5).unproject(camera).y;
	    })();
	    ...
	    function ParticleSystem(n, mousePos) {
	        ...
	        for (var i = 0; i < n; i++) {
	            this.pos[i] = new _three2['default'].Vector3(mousePos.x + 2, mousePos.y - 5, 0);
	            this.velocity[i] = new _three2['default'].Vector3(0, 0, 0);
	    ...
	    ParticleSystem.prototype.bindMaterial = function (material) {
	        this.system = new _three2['default'].PointCloud(this.geometry, material);
	    };
	    ...
	    var vertexShader = ["uniform vec3 color;", "uniform mat3 rot;", "attribute float lifeTime;", "attribute float emitted;", "varying vec3 vColor;", "varying float vTime;", "varying float vLifeTime;", "varying float vEmitted;", "void main() {", "vColor = color;", "vLifeTime = lifeTime;", "vEmitted = emitted;", "gl_PointSize = 70.0;", "gl_Position = projectionMatrix * modelViewMatrix *vec4(position, 1.0);", "}"].join("\n");
	    var fragShader = ["uniform float constLifeTime;", "uniform sampler2D texture;", "uniform float time;", "varying float vLifeTime;", "varying float vEmitted;", "varying vec3 vColor;", "float alpha;", "varying float vTime;", "void main() {", "gl_FragColor = texture2D(texture, gl_PointCoord);",
	    ...
	    "gl_FragColor = vec4(vColor,  gl_FragColor.y * vEmitted * vEmitted *vLifeTime/constLifeTime) * gl_FragColor ;", "}"].join("\n");

	    var material = new _three2['default'].ShaderMaterial({
	        uniforms: {
	            constLifeTime: { type: "f", value: pSystem.constLifeTime },
	            time: { type: "f", value: 1.0 },
	            color: { type: "c", value: new _three2['default'].Color(0xb5e853) },
	            texture: { type: 't', value: _three2['default'].ImageUtils.loadTexture('img/star.jpg') }
	        },
	        attributes: {
	    ...
	    window.addEventListener('mousemove', function (e) {
	        x = e.pageX;
	        y = e.pageY;
	        var current = new _three2['default'].Vector3();
